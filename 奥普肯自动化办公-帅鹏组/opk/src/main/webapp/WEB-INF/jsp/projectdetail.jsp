...
<body>
	...
	<div>
		<table class="tablelist"
			...
			<tr>
				<td>项目状态：${project.projectState.state}</td>
		...
		<center>
			...
			<button>
				<a
					href="approve.action?pId=${project.pId}&approveStateId=${project.approveStateId}"
					style="font-size: 20px">通过</a>
			</button>
			<button>
				<a href="decline.action?pId=${project.pId}" style="font-size: 20px">驳回</a>
			</button>
		</center>
	</div>
</body>
